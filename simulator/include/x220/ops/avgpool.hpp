#ifndef QUANTIZATION_X220_OPS_AVGPOOL_HPP
#define QUANTIZATION_X220_OPS_AVGPOOL_HPP
...
namespace x220 {
class Avgpool : public X220Operation {
 public:
  Avgpool();
...
#endif  // QUANTIZATION_X220_OPS_AVGPOOL_HPP
