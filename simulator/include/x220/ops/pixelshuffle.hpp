#ifndef QUANTIZATION_X220_OPS_PIXEL_SHUFFLE_HPP
#define QUANTIZATION_X220_OPS_PIXEL_SHUFFLE_HPP
...
namespace x220 {
class Pixelshuffle : public X220Operation {
 public:
  Pixelshuffle();
...
#endif  // QUANTIZATION_X220_OPS_PIXEL_SHUFFLE_HPP
