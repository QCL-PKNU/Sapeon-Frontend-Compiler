#ifndef QUANTIZATION_X220_OPS_ACTIVATIONS_HPP
#define QUANTIZATION_X220_OPS_ACTIVATIONS_HPP
...
namespace x220 {
class Activations : public X220Operation {
 public:
  Activations();
...
#endif  // QUANTIZATION_X220_OPS_ACTIVATIONS_HPP
