#ifndef QUANTIZATION_X220_OPS_CONNECTED_HPP
#define QUANTIZATION_X220_OPS_CONNECTED_HPP
...
namespace x220 {
class Connected : public X220Operation {
 public:
  Connected();
...
#endif  // QUANTIZATION_X220_OPS_CONNECTED_HPP
