...
X330ValidationDelegate::X330ValidationDelegate(Backend &parent, Arguments &args)
    : parent_(parent) {
  // Parse Arguments
...
tl::expected<void, SimulatorError> X330ValidationDelegate::Validate(
...
std::shared_ptr<Tensor> X330ValidationDelegate::Inference(
