#ifndef CUDNN_COMMON_UNARY_ELEMENTWISE_OPS_IMPL_CUH
#define CUDNN_COMMON_UNARY_ELEMENTWISE_OPS_IMPL_CUH
...
// 2. (optional) Define templated single element operator in
// unary_elementwise_ops_impl.cu
// 3. (optional) Implement specialized single element operator
// 4. Add op kernel class definition in unary_elementwise_ops.h
// 5. Add op kernel registration and compute specialization in
// unary_elementwise_ops.cc
...
#define UNARY_OPS()                        \
  ...
  UNARY_OP_NAME_EXPR(Mish, _Mish(a))       \
  UNARY_OP_NAME_EXPR(Celu, _Celu(a))       \
...
#endif  // CUDNN_COMMON_UNARY_ELEMENTWISE_OPS_IMPL_CUH
