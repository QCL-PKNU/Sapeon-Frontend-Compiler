#ifndef DUMP_DUMP_BINARY_HPP
#define DUMP_DUMP_BINARY_HPP
...
class DumpBinary : public Dump<Type> {
 public:
  DumpBinary(DumpLevel dump_level, const std::string &dump_path);
