#ifndef QUANTIZATION_X220_OPS_ELEMENT_WISE_ADD_HPP
#define QUANTIZATION_X220_OPS_ELEMENT_WISE_ADD_HPP
...
namespace x220 {
class EWAdd : public X220Operation {
 public:
  EWAdd();
...
#endif  // QUANTIZATION_X220_OPS_ELEMENT_WISE_ADD_HPP
