#ifndef QUANTIZATION_X220_OPS_LAVGPOOL_HPP
#define QUANTIZATION_X220_OPS_LAVGPOOL_HPP
...
namespace x220 {
class Lavgpool : public X220Operation {
 public:
  Lavgpool();
...
#endif  // QUANTIZATION_X220_OPS_LAVGPOOL_HPP
