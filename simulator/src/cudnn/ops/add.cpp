...
void SCOPE::InitOutputTensor() {
  ...
  ComputeOutputShape("Add", in_vector1, in_vector2, out_vector);
...
void SCOPE::OperationForward() {
  ...
  Impl_Add<Type>(stream, output_rank_or_simple_broadcast, &lhs_padded_strides,
